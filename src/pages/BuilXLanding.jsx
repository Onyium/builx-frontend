          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="text-center mb-20 max-w-3xl mx-auto">
              ...
              <p className="text-xl text-slate-300">
                Paga una tarifa plana por tu tecnología y recibe el <strong className="text-white">100%</strong> del dinero directo en tu cuenta o WhatsApp. Sin comisiones ocultas por venta, sin intermediarios.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="bg-white/[0.03] border border-white/10 rounded-3xl p-8 md:p-10 flex flex-col backdrop-blur-sm transition-transform hover:-translate-y-1">
                ...
                <ul className="space-y-5 mb-10 flex-1 text-slate-300">
                  <li className="flex gap-3 items-start"><span className="text-cyan-400 text-xl mt-0.5">✅</span> <span><strong>Diseño Automatizado con IA:</strong> Extracción de tu catálogo desde Instagram.</span></li>
                  <li className="flex gap-3 items-start"><span className="text-cyan-400 text-xl mt-0.5">✅</span> <span><strong>Integración a WhatsApp:</strong> Botón directo para que cierres la venta.</span></li>
                  <li className="flex gap-3 items-start"><span className="text-cyan-400 text-xl mt-0.5">✅</span> <span><strong>Panel de Control:</strong> Actualiza fotos y precios tú mismo desde el celular.</span></li>
                  ...
                  <li className="flex gap-3 items-start"><span className="text-yellow-500 text-xl mt-0.5">⚠️</span> <span><strong>Dominio compartido:</strong> Tu página usará el enlace <em>tunegocio.builx.com</em>.</span></li>
              ...
              <div className="bg-gradient-to-b from-blue-900/40 to-[#050B14] border-2 border-cyan-400/50 rounded-3xl p-8 md:p-10 flex flex-col relative shadow-[0_0_50px_rgba(34,211,238,0.15)] transform md:-translate-y-4">
                ...
                <ul className="space-y-5 mb-10 flex-1 text-slate-200">
                  ...
                  <li className="flex gap-3 items-start"><span className="text-blue-400 text-xl mt-0.5">🌐</span> <span><strong>Dominio Propio Incluido:</strong> Tu página será <em>www.tunegocio.com</em> (Nosotros cubrimos el costo anual).</span></li>
                  <li className="flex gap-3 items-start"><span className="text-blue-400 text-xl mt-0.5">🎨</span> <span><strong>100% Marca Blanca:</strong> Sin publicidad nuestra, tu marca es la única protagonista.</span></li>
                  <li className="flex gap-3 items-start"><span className="text-blue-400 text-xl mt-0.5">⚡</span> <span><strong>Galería de Alta Velocidad:</strong> Optimización extrema para que tus clientes no abandonen la página.</span></li>
            ...
            <div className="mt-24 max-w-4xl mx-auto bg-gradient-to-br from-white/[0.05] to-transparent border border-cyan-500/30 rounded-[2.5rem] p-8 md:p-12 text-center relative overflow-hidden backdrop-blur-xl shadow-[0_0_50px_rgba(34,211,238,0.05)]">
              {/* Adorno de luz en el fondo de la caja */}
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 text-lg leading-relaxed max-w-2xl mx-auto mb-10">
                  Escríbenos, envíanos el Instagram de tu negocio y nuestra IA construirá un Demo Interactivo <strong className="text-white">100% Gratis en menos de 30 minutos</strong>. Si te gusta cómo se ve y lo fácil que es recibir pedidos, eliges tu plan y lo activamos. Si no te gusta, no pagas absolutamente nada.
                </p>
                ...
                >
                  ...
                  Solicitar mi Demo Gratis por WhatsApp
                </a>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <details className="group bg-white/[0.03] border border-white/10 rounded-2xl cursor-pointer transition-all duration-300 hover:border-cyan-400/40 backdrop-blur-sm">
              ...
              <div className="px-6 pb-6 md:px-8 md:pb-8 text-slate-300 text-lg leading-relaxed mt-4">
                <strong>Absolutamente no.</strong> A diferencia de otras plataformas que te quitan entre el 2% y el 5% de tus ganancias, en BuilX solo pagas tu suscripción plana. Todo el dinero va directo a tu bolsillo.
              </div>
            </details>
            <details className="group bg-white/[0.03] border border-white/10 rounded-2xl cursor-pointer transition-all duration-300 hover:border-cyan-400/40 backdrop-blur-sm">
              <summary className="flex items-center justify-between p-6 md:p-8 font-bold text-lg md:text-xl text-white list-none">
            ...
            <details className="group bg-white/[0.03] border border-white/10 rounded-2xl cursor-pointer transition-all duration-300 hover:border-cyan-400/40 backdrop-blur-sm">
              ...
              <div className="px-6 pb-6 md:px-8 md:pb-8 text-slate-300 text-lg leading-relaxed mt-4">
                Para nada. La plataforma está diseñada para ser tan fácil de usar como subir una foto a redes sociales. Nosotros nos encargamos de todo el código y mantenimiento de los servidores.
              </div>
            </details>
          </div>
        </section>
